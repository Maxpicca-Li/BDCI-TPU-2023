...
def setup_optimizer(model, config):
    ...
    if config['training']['optimizer']['name'] == 'sgd':
        optimizer = optim.SGD([
            ...
            { 'params': model.deconv.parameters(), 'lr': base_lr / 10 },
...
def main(args_cuda, args_config):
    ...
    print(os.path.basename(args_config), os.path.basename(args_config)[:-5])
